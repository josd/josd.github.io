...
README
======
This single-file Python program computes a clear **Answer** to a clear **Question**,
emits a mathematically phrased **Reason why**, and runs a self-verifying
**Check (harness)** with multiple assertions that can fail loudly.
