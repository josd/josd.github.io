...
run :-
    ...
    write(Out,'\n'),
    write(Out,'% query\n'),
    write(Out,'\'http://example.org/etc#N1\'(_ELEMENT) => yes.\n'),
    write(Out,'\'http://example.org/etc#N10\'(_ELEMENT) => yes.\n'),
    write(Out,'\'http://example.org/etc#N100\'(_ELEMENT) => yes.\n'),
    write(Out,'\'http://example.org/etc#N1000\'(_ELEMENT) => yes.\n'),
    write(Out,'\'http://example.org/etc#N10000\'(_ELEMENT) => yes.\n'),
    write(Out,'\'http://example.org/etc#N100000\'(_ELEMENT) => yes.\n'),
    close(Out).
