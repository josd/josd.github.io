...
run :-
    ...
    write(Out,'\n'),
    write(Out,'% query\n'),
    write(Out,'query(\'http://example.org/etc#N1\'(_ELEMENT)).\n'),
    write(Out,'query(\'http://example.org/etc#N10\'(_ELEMENT)).\n'),
    write(Out,'query(\'http://example.org/etc#N100\'(_ELEMENT)).\n'),
    write(Out,'query(\'http://example.org/etc#N1000\'(_ELEMENT)).\n'),
    close(Out).
