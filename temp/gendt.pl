...
run :-
    ...
    format(Out,"~n",[]),
    format(Out,"% query~n",[]),
    format(Out,"'http://www.w3.org/1999/02/22-rdf-syntax-ns#type'(_ELEMENT,'https://josd.github.io/ns#N1') => yes.~n",[]),
    format(Out,"'http://www.w3.org/1999/02/22-rdf-syntax-ns#type'(_ELEMENT,'https://josd.github.io/ns#N10') => yes.~n",[]),
