...
* Specific colors (e.g., a particular shade of blue).
* Emotional qualities (e.g., anger or joy).
* **Mathematical and logical forms** (e.g., the structure of a circle, the laws of arithmetic, or the principles of topology).
