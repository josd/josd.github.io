...
'https://josd.github.io/popeye#findpath'(_SCOPE,[Goal,Path,Duration,Cost,Belief,Comfort,Limits]) :-
...
findpaths(Maps_s,Goal,Path_s,Duration_s,Cost_s,Belief_s,Comfort_s,Path,Duration,Cost,Belief,Comfort,Limits) :-
    ...
    clause('https://josd.github.io/popeye#description'(Map,[From,Transition,To,Action,Duration_n,Cost_n,Belief_n,Comfort_n]),Where),
    From,
    Where,
    'https://josd.github.io/popeye#description'(Map,[From,Transition,To,Action,Duration_n,Cost_n,Belief_n,Comfort_n]),
...
% test data
:- dynamic('https://josd.github.io/popeye#description'/2).
:- dynamic('https://josd.github.io/popeye#location'/2).

% partial map of Belgium
'https://josd.github.io/popeye#description'(
    'http://example.org/ns#map_be',
    [   'https://josd.github.io/popeye#location'(S,'http://example.org/ns#gent'),
        true,
        'https://josd.github.io/popeye#location'(S,'http://example.org/ns#brugge'),
...
'https://josd.github.io/popeye#description'(
    ...
    [   'https://josd.github.io/popeye#location'(S,'http://example.org/ns#gent'),
        true,
        'https://josd.github.io/popeye#location'(S,'http://example.org/ns#kortrijk'),
...
'https://josd.github.io/popeye#description'(
    ...
    [   'https://josd.github.io/popeye#location'(S,'http://example.org/ns#brugge'),
        true,
        'https://josd.github.io/popeye#location'(S,'http://example.org/ns#oostende'),
...
% current state
'https://josd.github.io/popeye#location'('http://example.org/ns#i1','http://example.org/ns#gent').

% query
query('https://josd.github.io/popeye#findpath'(
    'http://example.org/ns#map_be',
    [   'https://josd.github.io/popeye#location'(_SUBJECT,'http://example.org/ns#oostende'),
        _PATH,
        _DURATION,
        _COST,
        _BELIEF,
