...
:- dynamic('https://josd.github.io/popeye#sdcoding'/2).
...
% superdense coding
'https://josd.github.io/popeye#sdc'(N,M) :-
    r(X,Y),
    alice(N,[X,B]),
    bob([B,Y],M),
    (   'https://josd.github.io/popeye#sdcoding'(N,M)
    ->  retract('https://josd.github.io/popeye#sdcoding'(N,M))
    ;   assertz('https://josd.github.io/popeye#sdcoding'(N,M))
    ).

% superdense coding appearing an odd number of times
reason :-
    'https://josd.github.io/popeye#sdc'(_N,_M),
    fail;
    true.

% query
query('https://josd.github.io/popeye#sdcoding'(_N,_M)).
