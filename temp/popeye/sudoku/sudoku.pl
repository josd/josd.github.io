...
% sudoku
'https://josd.github.io/heisener/etc#sudoku'(Puzzle,Solution) :-
...
% query
query('https://josd.github.io/heisener/etc#sudoku'([8,_,_,4,_,5,_,_,_,6,_,4,_,_,_,_,_,1,_,_,_,_,1,_,_,_,2,_,3,7,2,_,_,_,_,_,_,_,_,_,5,1,_,_,9,_,_,_,_,_,4,_,3,_,9,_,2,_,_,8,1,_,7,7,_,_,_,_,_,_,_,_,_,_,1,_,_,2,_,_,_],_ANSWER)).
