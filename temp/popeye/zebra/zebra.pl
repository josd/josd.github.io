...
% 'https://josd.github.io/popeye#solve_zebra'/2 - The main predicate for solving the puzzle
'https://josd.github.io/popeye#zebra'(WaterDrinker, ZebraOwner) :-
...
% query
query('https://josd.github.io/popeye#zebra'(_WaterDrinker, _ZebraOwner)).
