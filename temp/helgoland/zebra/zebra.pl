...
% 'https://josd.github.io/helgoland#solve_zebra'/2 - The main predicate for solving the puzzle
'https://josd.github.io/helgoland#zebra'(WaterDrinker, ZebraOwner) :-
...
% query
query('https://josd.github.io/helgoland#zebra'(_WaterDrinker, _ZebraOwner)).
