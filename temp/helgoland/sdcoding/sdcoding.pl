...
:- dynamic('https://josd.github.io/helgoland#sdcoding'/2).
...
% superdense coding
'https://josd.github.io/helgoland#sdc'(N,M) :-
    r(X,Y),
    alice(N,[X,B]),
    bob([B,Y],M),
    (   'https://josd.github.io/helgoland#sdcoding'(N,M)
    ->  retract('https://josd.github.io/helgoland#sdcoding'(N,M))
    ;   assertz('https://josd.github.io/helgoland#sdcoding'(N,M))
    ).

% superdense coding appearing an odd number of times
reason :-
    'https://josd.github.io/helgoland#sdc'(_N,_M),
    fail;
    true.

% query
query('https://josd.github.io/helgoland#sdcoding'(_N,_M)).
