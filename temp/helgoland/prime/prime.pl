...
'https://josd.github.io/helgoland#primerange'([A,B],L) :-
...
'https://josd.github.io/helgoland#totient'(N,Phi) :-
...
% query
query('https://josd.github.io/helgoland#primerange'([0,100],_ANSWER)).
query('https://josd.github.io/helgoland#primerange'([1000000,1000100],_ANSWER)).
query('https://josd.github.io/helgoland#totient'(271,_ANSWER)).
query('https://josd.github.io/helgoland#totient'(2718281,_ANSWER)).
query('https://josd.github.io/helgoland#totient'(27182818284,_ANSWER)).
query('https://josd.github.io/helgoland#totient'(271828182845904,_ANSWER)).
