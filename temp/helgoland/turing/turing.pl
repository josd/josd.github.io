...
'https://josd.github.io/helgoland#compute'([],OutTape) :-
    start(_MACHINE,I),
    find(I,[],#,[ ],OutTape).
'https://josd.github.io/helgoland#compute'([Head|Tail],OutTape) :-
    start(_MACHINE,I),
...
% query
query('https://josd.github.io/helgoland#compute'([1,0,1,0,0,1],_ANSWER)).
query('https://josd.github.io/helgoland#compute'([1,0,1,1,1,1],_ANSWER)).
query('https://josd.github.io/helgoland#compute'([1,1,1,1,1,1],_ANSWER)).
query('https://josd.github.io/helgoland#compute'([],_ANSWER)).
