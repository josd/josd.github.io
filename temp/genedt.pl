...
run :-
    ...
    write(Out,'        document.write("<style>p {word-wrap: break-word}</style>");\n'),
    write(Out,'        document.write("<h2>Running ", location.pathname.split("/").slice(-1), "</h2>");\n'),
    write(Out,'        document.write("<p>Query = ", query, "</p>");\n'),
    write(Out,'        document.write("<p>", session.format_answer(answer, {quoted: true}), "</p>");\n'),
    write(Out,'    },\n'),
