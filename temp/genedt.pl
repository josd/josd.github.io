...
run :-
    ...
    format(Out,"~n",[]),
    format(Out,"'http://www.w3.org/1999/02/22-rdf-syntax-ns#type'(A,C) :- 'http://www.w3.org/2000/01/rdf-schema#subClassOf'(B,C),'http://www.w3.org/1999/02/22-rdf-syntax-ns#type'(A,B).~n",[]),
    format(Out,"~n",[]),
    (   between(0,99999,I),
        J is I+1,
