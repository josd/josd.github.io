# Eyelog and Eyeling: Recommended R&D Direction
...
3. Eyelog checks rules, constraints, or consequences.
...
- RDF import into Eyelog facts;
- Eyelog export to RDF or N3 when useful;
...
- translation to and from Eyelog;
...
- Eyelog provides the broader AI-facing research path.
